...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name='users/login.html'), name='login-page'), # template_name where to look for template
    ...
    path('api/', include('users.api.urls', namespace='api-user')),
